...
export const ParticipantSection = () => {
  const participants = [
    {
      id: 1,
      avatar: "/images/ellipse-6.svg",  // Image source
      quote: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vulputate libero et velit interdum, ac aliquet odio mattis. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.",
      name: "Mike Torello",
  ...
  return (
    <section
      className="absolute w-full h-auto top-[6186px] left-[589px]"
      role="region"
      aria-label="Participant testimonial"
    >
      <div className="flex space-x-6"> {/* Flex container to display items side by side */}
        {participants.map((participant) => (
          <div key={participant.id} className="relative w-[537px] h-[318px]">
