...
export const LoginPage = () => {
  ...
  const handlePasswordReset = (e) => {
    ...
    console.log("Password reset for:", resetEmail, "New password:", newPassword);
  ...
  return (
    <div className="min-h-screen bg-black flex flex-col items-center w-full p-4 sm:p-0">
      {/* Main Container */}
      <div className="relative w-full max-w-[1440px] min-h-[800px] sm:min-h-[1024px] bg-white overflow-hidden rounded-lg sm:rounded-none">
        ...
        {/* Login/Reset Form */}
        <div className="absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 md:translate-x-0 md:left-auto md:right-[30px] lg:right-[50px] w-full max-w-[95vw] sm:max-w-[400px] lg:max-w-[456px]">
          ...
          {!resetStep ? (
            ...
            <div className="relative bg-white bg-opacity-20 backdrop-blur-sm rounded-xl p-6 sm:p-8 shadow-lg">
              <form onSubmit={handleLogin}>
                {/* Tabs */}
                <nav className="flex justify-center mb-6 sm:mb-8" role="tablist">
                  <button
                    type="button"
                    onClick={() => handleTabSwitch("login")}
                    className={`text-[24px] sm:text-[29.4px] font-bold leading-[41.2px] mr-4 ${activeTab === "login"
                ...
                <div className="mb-4 sm:mb-6">
                  ...
                  <button
                    ...
                    className="mt-1 text-xs text-white font-bold hover:underline float-right"
                  >
                    Forgot Password?
                  </button>
                </div>
                ...
                <button
                  type="submit"
                  className="w-full h-12 mt-4 bg-gradient-to-b from-[#562780] to-[#8257a9] text-white font-bold text-xs sm:text-sm rounded-[10px] hover:opacity-90"
                >
                  Log In
                </button>
                ...
                >
                  <img src="/images/google-logo.png" alt="Google logo" className="w-4 h-4" />
                  <span className="text-black text-xs font-bold">Sign in with Google</span>
                </button>
            ...
            <div className="relative bg-white rounded-xl p-6 sm:p-8 shadow-lg">
              ...
              <form onSubmit={handleResetRequest} className="flex flex-col items-center">
                ...
                <div className="flex flex-col items-center mb-6 w-full">
                  <div className="w-[343px] text-left"> {/* Container khusus untuk label */}
                    <label
                      htmlFor="email-input"
            ...
            <div className="relative bg-white rounded-xl p-6 sm:p-8 shadow-lg">
              ...
              <form onSubmit={handleVerifyCode}>
                ...
                <div className="mb-6 text-center">
                  ...
                  <p className="[font-family:'Inter-Regular',Helvetica] font-normal text-black text-base tracking-[-0.18px]">
                    We sent a verification code to your email<span className="font-bold"></span>
                  </p>
                </div>
